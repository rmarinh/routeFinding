...
public class ScriptRunner {
    ...
    public ScriptRunner(Connection connection, boolean autoCommit,
        ...
        try {
            ...
            Log.logWarning("Unable to access or create the db_create log");
        }
        try {
            ...
            Log.logError("Unable to access or create the db_create error log");
        }
    ...
    /**
     * modificar o delimitador
     * @param delimiter delimitador
     * @param fullLineDelimiter delimitador de linha
     */
    ...
    public void runScript(Reader reader) throws IOException, SQLException {
        try {
            ...
            Log.logError("Error running script.  Cause: " + e.toString());
